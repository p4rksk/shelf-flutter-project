...
final UserData userData = UserData(
  ...
  reviews: [
    ...
    MyReview(
      ...
      reviewContent: '추천합니다!',
      date: '2024-06-25',
      bookTitle: '나를 소모하지 않는 현명한 태도에 관하여',
      bookAuthor: '마티아스 뇔케',
    ),
  ],
);
...
final List<WishlistBook> wishlistBooks = [
  ...
  WishlistBook(
      title: '책 제목 2', author: '저자 2', imagePath: 'assets/images/book6.png'),
  WishlistBook(
      title: '책 제목 3', author: '저자 3', imagePath: 'assets/images/book2.png'),
  WishlistBook(
      title: '책 제목 4', author: '저자 4', imagePath: 'assets/images/book3.png'),
  WishlistBook(
      title: '책 제목 5', author: '저자 5', imagePath: 'assets/images/book5.png'),
  WishlistBook(
      title: '책 제목 6', author: '저자 6', imagePath: 'assets/images/book8.png'),
];
